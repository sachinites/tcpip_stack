...
graph_t *standalone_node_topology(void) {
    ...
    node_t *R0 = create_graph_node(topo, (c_string)"R0");
    node_set_loopback_address(R0, "122.1.1.1");
    return topo;
    node_t *R1 = create_graph_node(topo, (c_string)"R1");
...
build_first_topo(void){
    ...
    node_t *R0_re = create_graph_node(topo, (c_string)"R0_re");
    node_t *R1_re = create_graph_node(topo, (c_string)"R1_re");
    node_t *R2_re = create_graph_node(topo, (c_string)"R2_re");
...
run node H1 ping 13.1.1.2
    ...
    node_t *H1 = create_graph_node(topo, (c_string)"H1");
    node_t *H2 = create_graph_node(topo, (c_string)"H2");
    node_t *H3 = create_graph_node(topo, (c_string)"H3");
    node_t *H4 = create_graph_node(topo, (c_string)"H4");
    node_t *L3SW = create_graph_node(topo, (c_string)"L3SW");
...
build_simple_l2_switch_topo(void){
    ...
    node_t *H3 = create_graph_node(topo, (c_string)"H3");
    node_t *H4 = create_graph_node(topo, (c_string)"H4");
    node_t *L2SW = create_graph_node(topo, (c_string)"L2SW");
...
run node R1 ping 122.1.1.3
    ...
    node_t *R1 = create_graph_node(topo, (c_string)"R1");
    node_t *R2 = create_graph_node(topo, (c_string)"R2");
    node_t *R3 = create_graph_node(topo, (c_string)"R3");
    node_t *R4 = create_graph_node(topo, (c_string)"R4");
...
build_dualswitch_topo(void){
   ...
   +------+---+ eth0/1      eth0/2|          |TR,V10,V11            TR,V10,V11|         |AC,V10        10.1.1.6/24|        |         
    ...
    node_t *H4 = create_graph_node(topo, (c_string)"H4");
    node_set_loopback_address(H4, "122.1.1.4");
    node_t *H5 = create_graph_node(topo, (c_string)"H5");
    node_set_loopback_address(H5, "122.1.1.5");
    node_t *H6 = create_graph_node(topo, (c_string)"H6");
    node_set_loopback_address(H6, "122.1.1.6");

    node_t *L2SW1 = create_graph_node(topo, (c_string)"L2SW1");
    node_t *L2SW2 = create_graph_node(topo, (c_string)"L2SW2");
...
*/
    ...
    node_t *R3 = create_graph_node(topo, (c_string)"R3");
    node_t *R4 = create_graph_node(topo, (c_string)"R4");
    node_t *R5 = create_graph_node(topo, (c_string)"R5");
...
evpn_spine_leaf(void) {
    ...
    /* Create Spine nodes */
    node_t *Spine1 = create_graph_node(topo, (c_string)"Spine1");
    node_t *Spine2 = create_graph_node(topo, (c_string)"Spine2");
    
    /* Create Leaf nodes */
    node_t *Leaf1 = create_graph_node(topo, (c_string)"Leaf1");
    node_t *Leaf2 = create_graph_node(topo, (c_string)"Leaf2");
    node_t *Leaf3 = create_graph_node(topo, (c_string)"Leaf3");
    node_t *Leaf4 = create_graph_node(topo, (c_string)"Leaf4");
    
    /* Create Workload (Host) nodes */
    node_t *Host1 = create_graph_node(topo, (c_string)"Host1");
    node_t *Host2 = create_graph_node(topo, (c_string)"Host2");
    node_t *Host3 = create_graph_node(topo, (c_string)"Host3");
    node_t *Host4 = create_graph_node(topo, (c_string)"Host4");
