/*
 * cp2dp.cpp — Control-plane → Datapath API implementations
 *
 * Each API allocates a dp_msg_t, fills the component payload, and submits
 * it via cp2dp_submit(). Layout mirrors cp2dp.h section order.
 */
 ...
 * Submit messages to datapath; convert CP <-> DP packet buffers.
 * ======================================================================== */
...
/*
 * Transmit a CP pkt_block out an interface.
 *   Note: CP owns pkt_block; DP frees the converted mbuf after xmit.
 *   FIX ME: separate CP/DP memory managers will need ownership revisit.
 */
void
...
/* Wrap a CP pkt_block into an rte_mbuf. */
struct rte_mbuf *
...
/* Copy a datapath mbuf into a CP pkt_block. */
cp_pkt_block_t *
 ...
 * Push L4+ payloads into the L3 datapath northbound path.
 * ======================================================================== */

/* IPv4 L4+ payload → L3 northbound. */
void
                   ...
                   uint16_t std_ip_protocol)
{
    ...
    ip_hdr->src_ip = htonl(ip_pton(NODE_RTRID_ADDR(node)));
...
/* ========================================================================
 * VLAN MAC table
 * Program learned / static MACs into a VLAN MAC table.
 * ======================================================================== */
                          ...
                          uint32_t vlan_bd_ifindex)
{
    ...
    mac_update_msg->table_vlan_id = vlan_id;
 ...
 * Program BD MAC entries (local OIF or MPLS tunnel nexthops).
 * ======================================================================== */

/* BD MAC via local OIF. */
void
...
/* BD MAC via MPLS tunnel fwd-spec. */
void
...
/* Clear all dynamic MACs in a BD table. */
void
...
/* ========================================================================
 * VRF
 * Create / destroy VRFs and bind interfaces.
 * ======================================================================== */
...
/* ========================================================================
 * Interface lifecycle
 * Create / delete interfaces and attach ACLs.
 * ======================================================================== */

/* Synchronous create so caller can proceed safely. */
void
 ...
 * IPv4/IPv6/GRE, admin, switchport, VLAN/VNI bindings.
 * ======================================================================== */
 ...
 * Bind ACs to BDs, 802.1Q encap, LMAC learning queue.
 * ======================================================================== */
...
/* ========================================================================
 * Packet trap rules
 * Install / uninstall CP packet trap classifiers on interfaces.
 * ======================================================================== */
