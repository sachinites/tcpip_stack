...
typedef enum {
	...
	TASK_PRIORITY_CRITICAL = TASK_PRIORITY_FIRST,
	TASK_PRIORITY_CP_TO_DP = TASK_PRIORITY_CRITICAL,
	TASK_PRIORITY_OPERATIONAL_CLI =  TASK_PRIORITY_CRITICAL,
	...
	TASK_PRIORITY_LOW_MEDIUM,
	TASK_PRIORITY_COMPUTE_LOW = TASK_PRIORITY_LOW_MEDIUM,
	
	TASK_PRIORITY_LOW,
	TASK_PRIORITY_CONFIG_CLI =  TASK_PRIORITY_LOW,

	TASK_PRIORITY_VERY_LOW,
	TASK_PRIORITY_GARBAGE_COLLECTOR = TASK_PRIORITY_VERY_LOW,
