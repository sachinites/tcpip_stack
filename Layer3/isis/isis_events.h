...
#define ISIS_EVENT_REDUNDANT_JOB_CANCELLED_BIT (1 << isis_event_redundant_job_cancelled)
    isis_event_job_schedule_invalidated,
#define ISIS_EVENT_JOB_SCHEDULE_INVALIDATED_BIT (1 << isis_event_job_schedule_invalidated)
